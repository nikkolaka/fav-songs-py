...
const toggleButton = document.getElementById("toggle-tracker");
...
function renderAccount(account) {
  ...
  favoritesTable.innerHTML = account.favorites
    ...
    .join("");
  toggleButton.textContent = account.status === "Active" ? "Pause tracking" : "Resume tracking";
}
...
const tabs = document.querySelectorAll(".rail-btn");
